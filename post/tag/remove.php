...
class PostTagRemove extends BusinessLayer
{
	...
	public function run()
	{
		try
		{
			if($this->getMethod() == "DELETE")
	    	{
				...
				$statement = $this->m_db->prepare("SELECT * FROM post_tag
				...
				{  
					$statement = $this->m_db->prepare("DELETE FROM post_tag
