	...
	public function run()
	{
		try
		{
			if($this->getMethod() == "POST")
			{
				...
				$statement = $this->m_db->prepare("UPDATE user SET firstname = :firstname, lastname = :lastname, email = :email, password = :password, gender = :gender, birthdate = :birthdate WHERE idUser = :idUser");
